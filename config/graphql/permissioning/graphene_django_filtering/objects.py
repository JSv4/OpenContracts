...
# TODO - confirm we actually may not need this... since I *think* we hooked into graphene's conversions and are
#  replacing ConnectionFields
...
class DjangoObjectType(ObjectType):
    ...
    def __init_subclass_with_meta__(
        ...
        **options
        ...
        # TODO - this chain needs modification
        django_fields = yank_fields_from_attrs(
            construct_fields(model, registry, fields, exclude, convert_choices_to_enum),
            _as=graphene.Field,
        )
        print(f"django fields:  {django_fields}")
