...
import { GetCorpusMetadataInputs, GetCorpusMetadataOutputs, GET_CORPUS_METADATA } from "../../../graphql/queries";
...
export const FilterToMetadataSelector = ({
    ...
    if (metadata_error) {
        toast.error("Error fetching metadata for corpus... can't properly filter on metadata");
    }
    ...
    const handleChange = (e: SyntheticEvent<HTMLElement, Event>,  data: DropdownProps) => selectedMetaAnnotationId(data.value ? String(data.value) : "");
