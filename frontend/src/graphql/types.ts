...
export type AnalysisType = Node & {
  ...
  isPublic?: Scalars["Boolean"];
  creator?: UserType;
  analyzer_id: Scalars["String"];
  analyzer_metadata: Record<any, any>;
  description: Scalars["String"];
  analyzed_corpus: CorpusTypeConnection;
  analyzed_documents: DocumentTypeConnection;
  resulting_annotations: AnnotationTypeConnection;
  uses_annotation_labels: AnnotationLabelTypeConnection;
  analysis_started: Scalars["DateTime"];
  analysis_completed: Scalars["DateTime"];
  created: Scalars["DateTime"];
  modified: Scalars["DateTime"];
};
