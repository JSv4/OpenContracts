...
export const Annotations = () => {
  ...
  if (corpus_data?.corpus?.labelSet?.annotationLabels?.edges) {
    labels = corpus_data.corpus.labelSet.annotationLabels.edges
      .flatMap((f) => (!!f && f?.node ? [f] : []))
      .map((edge) => edge.node) as AnnotationLabelType[];
  }
