...
def download_model():
    ...
    try:
        ...
        logger.info(
            f"Minnesota Case Law ModernBERT model has been downloaded and saved to '{model_save_path}'."
        )

        # Test the model with a simple example
        test_sentence = (
            "This is a test sentence for the Minnesota Case Law ModernBERT model."
        )
...
if __name__ == "__main__":
    ...
    if success:
        print(
            f"✅ Minnesota Case Law ModernBERT model successfully downloaded to '{model_save_path}'"
        )
    else:
