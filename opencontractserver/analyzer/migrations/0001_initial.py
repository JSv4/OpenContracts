...
import opencontractserver.utils.data_types
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(opencontractserver.utils.data_types.JobStatus['CREATED'], opencontractserver.utils.data_types.JobStatus['CREATED']), (opencontractserver.utils.data_types.JobStatus['QUEUED'], opencontractserver.utils.data_types.JobStatus['QUEUED']), (opencontractserver.utils.data_types.JobStatus['RUNNING'], opencontractserver.utils.data_types.JobStatus['RUNNING']), (opencontractserver.utils.data_types.JobStatus['COMPLETED'], opencontractserver.utils.data_types.JobStatus['COMPLETED']), (opencontractserver.utils.data_types.JobStatus['FAILED'], opencontractserver.utils.data_types.JobStatus['FAILED'])], default='CREATED', max_length=24)),
            ],
            options={
