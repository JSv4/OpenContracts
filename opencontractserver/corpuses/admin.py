...
class CorpusAdmin(GuardedModelAdmin):
    ...
    list_display = ["id", "display_icon", "is_public", "allow_comments", "title", "description", "backend_lock",
                    "user_lock"]
    ...
    def make_public(self, request, queryset):
        ...
        self.message_user(request, f"Started making {queryset.count()} corpus(es) public.")
