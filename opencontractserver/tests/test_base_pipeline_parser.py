...
from opencontractserver.annotations.models import Annotation, Relationship, AnnotationLabel
...
class TestMockParser(TestCase):
    ...
    def test_mock_parser_relationship_import(self):
        ...
        self.assertIsNotNone(parsed_data, "Parser should return a valid OpenContractDocExport.")
