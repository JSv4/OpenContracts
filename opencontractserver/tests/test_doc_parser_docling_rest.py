...
from opencontractserver.pipeline.parsers.docling_parser_rest import DoclingParserRest
...
class TestDoclingParserRest(TestCase):
    ...
    @patch("opencontractserver.pipeline.parsers.docling_parser_rest.default_storage.open")
