...
from opencontractserver.llms.agents.core_agents import UnifiedChatResponse, UnifiedStreamResponse
...
class TestLongConversationAPI(TestCase):
    ...
    async def test_anonymous_conversation_creation(self):
        ...
        with patch('opencontractserver.llms.agents.llama_index_agents.OpenAIAgent') as MockOpenAIAgent:
            ...
            with patch('opencontractserver.llms.agents.llama_index_agents.Settings'), \
