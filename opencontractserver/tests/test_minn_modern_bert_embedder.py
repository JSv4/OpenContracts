...
from opencontractserver.pipeline.embedders.minn_modern_bert_embedder import MinnModernBERTEmbedder, MinnModernBERTEmbedder768
...
class TestMinnModernBERTEmbedder(unittest.TestCase):
    ...
    @patch('opencontractserver.pipeline.embedders.minn_modern_bert_embedder.SentenceTransformer')
    ...
    @patch('opencontractserver.pipeline.embedders.minn_modern_bert_embedder.os.path.exists')
    @patch('opencontractserver.pipeline.embedders.minn_modern_bert_embedder.SentenceTransformer')
